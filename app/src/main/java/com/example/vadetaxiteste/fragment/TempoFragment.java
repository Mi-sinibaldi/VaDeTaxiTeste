...
public class TempoFragment extends Fragment {
    ...
    private TextView textViewClima, textViewHumidadePorcentagem, textViewHoraNascer, textViewHoraPorSol;
    ...
    private void loadUi(View view) {
        ...
        textViewHumidadePorcentagem = view.findViewById(R.id.textViewHumidadePorcentagem);
    ...
    private void setUi(WeatherResponse weatherResponse) {
        textViewCidade.setText(weatherResponse.getName());
        ...
        textViewHumidadePorcentagem.setText(Integer.toString(weatherResponse.getMain().getHumidity()) + "%");
